...
// 상속은 상태와 행위를 물려받을 수 있지만 꼭 타입이 일치해야 한다.
class CheeseHamburger extends Hamburger{ // 치즈햄버거 = 햄버거이기 때문에 상속 가능
    // 겹치지 않는 필드만 물려받는다.
    String name = "치즈햄버거";
}
...
public class OOPEx02 {
    public static void main(String[] args) {
        ...
        System.out.println("재료의 이름은 : " + ch1.재료1);
        System.out.println("재료의 이름은 : " + ch1.재료2);
